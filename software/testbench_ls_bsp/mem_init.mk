...
# Memory: ddr2_ram
MEM_0 := ddr2_ram
$(MEM_0)_NAME := ddr2_ram
$(MEM_0)_MEM_INIT_FILE_PARAM_NAME := ABS_RAM_MEM_INIT_FILENAME
$(MEM_0)_START := 0x00000000
$(MEM_0)_END := 0x3fffffff
$(MEM_0)_SPAN := 0x40000000
$(MEM_0)_HIERARCHICAL_PATH := ddr2_ram
$(MEM_0)_WIDTH := 256
$(MEM_0)_HEX_DATA_WIDTH := 256
...
# Memory: ddr2_ram_1
MEM_1 := ddr2_ram_1
$(MEM_1)_NAME := ddr2_ram_1
$(MEM_1)_MEM_INIT_FILE_PARAM_NAME := ABS_RAM_MEM_INIT_FILENAME
$(MEM_1)_START := 0x40000000
$(MEM_1)_END := 0x7fffffff
$(MEM_1)_SPAN := 0x40000000
$(MEM_1)_HIERARCHICAL_PATH := ddr2_ram_1
$(MEM_1)_WIDTH := 256
$(MEM_1)_HEX_DATA_WIDTH := 256
$(MEM_1)_ENDIANNESS := --little-endian-mem
$(MEM_1)_CREATE_LANES := 0


# Memory: system_ram
MEM_2 := testbench_ls_system_ram
$(MEM_2)_NAME := system_ram
...
$(MEM_2)_START := 0x80080000
$(MEM_2)_END := 0x800fcfff
$(MEM_2)_SPAN := 0x0007d000
$(MEM_2)_HIERARCHICAL_PATH := system_ram
$(MEM_2)_WIDTH := 32
...
.PHONY: system_ram
system_ram: check_elf_exists $(MEM_INIT_DIR)/$(MEM_2).hex $(HDL_SIM_DIR)/$(MEM_2).dat $(HDL_SIM_DIR)/$(MEM_2).sym
