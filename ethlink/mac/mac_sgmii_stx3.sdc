...
#create_clock -name {input_clock_50} -period 20 [get_ports {OSC_50_B2}] # DE4
...
create_generated_clock -name {input_clock_125} -multiply_by 5 -divide_by 2 -source [get_pins {ethlink_inst|PLL|altpll_refclk_inst|altpll_component|auto_generated|pll1|inclk[0]}] [get_pins {ethlink_inst|PLL|altpll_refclk_inst|altpll_component|auto_generated|pll1|clk[0]}]
#create_generated_clock -add -name {input_clock_125} -source [get_pins {top1_inst|PLL|altpll_refclk_inst|altpll_component|auto_generated|pll1|inclk[0]}] [get_pins {top1_inst|PLL|altpll_refclk_inst|altpll_component|auto_generated|pll1|clk[0]}]
# Note: input_clock_125 generated by pll
