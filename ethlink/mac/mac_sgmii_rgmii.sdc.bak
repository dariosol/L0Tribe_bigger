...
set clock_125_driver {ethlink_inst|PLL|altpll_refclk_inst|altpll_component|auto_generated|pll1|clk[0]}  
create_generated_clock -name {input_clock_125} -multiply_by 5 -divide_by 2 -source [get_pins {ethlink_inst|PLL|altpll_refclk_inst|altpll_component|auto_generated|pll1|inclk[0]}] [get_pins $clock_125_driver]
